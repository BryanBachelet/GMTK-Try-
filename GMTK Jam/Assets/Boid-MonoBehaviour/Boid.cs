...
public class Boid : MonoBehaviour
{
    ...
    void Start()
    {
            mySimu = transform.parent.GetComponent<Simulation>();
    ...
    void UpdateAlignment()
    {
        ...
        foreach (var neighbor in neighbors)
        {
            ...
            averageVelocity += (mySimu.velocity * 20);
        }
    ...
    void UpdateMove()
    {
        ...
        transform.SetPositionAndRotation(pos + transform.parent.transform.position, rot);
